...
<span class="line"><span>note: Writing \`/tmp/jl_49kuzx/main.pdf\` (10.0048828125 KiB)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        )</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">W</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">save</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">joinpath</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@__DIR__</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;public&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;example.docx&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), doc)</span></span></code></pre></div><p>Download <code>example.docx</code>: <a href="example.docx" download><img src="`+t+`" width="60"></a></p><h2 id="typst" tabindex="-1">Typst <a class="header-anchor" href="#typst" aria-label="Permalink to &quot;Typst&quot;">​</a></h2><p>You can print <a href="https://github.com/typst/typst" target="_blank" rel="noreferrer">Typst</a> table code to any IO via <code>show(io, MIME&quot;text/typst&quot;, table)</code>. From SummaryTables v2.0 on, the Typst backend is using the native table functionality in Typst v0.11. Previous versions used the <a href="https://github.com/PgBiel/typst-tablex/" target="_blank" rel="noreferrer">tablex</a> package.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> SummaryTables</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DataFrames</span></span>
