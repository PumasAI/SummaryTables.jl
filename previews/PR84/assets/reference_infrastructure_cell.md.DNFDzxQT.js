import{_ as i,c as n,o as a,az as t}from"./chunks/framework.Caa2I_Ss.js";const E=JSON.parse('{"title":"Cell","description":"","frontmatter":{},"headers":[],"relativePath":"reference/infrastructure/cell.md","filePath":"reference/infrastructure/cell.md","lastUpdated":null}'),e={name:"reference/infrastructure/cell.md"};function l(h,s,p,r,k,d){return a(),n("div",null,s[0]||(s[0]=[t(`<h1 id="Cell" tabindex="-1"><code>Cell</code> <a class="header-anchor" href="#Cell" aria-label="Permalink to &quot;\`Cell\` {#Cell}&quot;">​</a></h1><h2 id="Argument-1:-value" tabindex="-1">Argument 1: <code>value</code> <a class="header-anchor" href="#Argument-1:-value" aria-label="Permalink to &quot;Argument 1: \`value\` {#Argument-1:-value}&quot;">​</a></h2><p>This is the content of the <code>Cell</code>. How it is rendered is decided by the output format and what <code>show</code> methods are defined for the type of <code>value</code> and the respective output <code>MIME</code> type. If no output-specific <code>MIME</code> type has a <code>show</code> method, the fallback is always the generic text output.</p><p>The following are some types which receive special handling by SummaryTables.</p><h3 id="Special-Cell-value-types" tabindex="-1">Special <code>Cell</code> value types <a class="header-anchor" href="#Special-Cell-value-types" aria-label="Permalink to &quot;Special \`Cell\` value types {#Special-Cell-value-types}&quot;">​</a></h3><h4 id="Floating-point-numbers" tabindex="-1">Floating point numbers <a class="header-anchor" href="#Floating-point-numbers" aria-label="Permalink to &quot;Floating point numbers {#Floating-point-numbers}&quot;">​</a></h4><p>Most tables display floating point numbers, however, the formatting of these numbers can vary. SummaryTables postprocesses every table in order to find unformatted floating point numbers. These are then given the default, table-wide, formatting.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> SummaryTables</span></span>
...
</table></div><h2 id="Optional-argument-2:-cellstyle" tabindex="-1">Optional argument 2: <code>cellstyle</code> <a class="header-anchor" href="#Optional-argument-2:-cellstyle" aria-label="Permalink to &quot;Optional argument 2: \`cellstyle\` {#Optional-argument-2:-cellstyle}&quot;">​</a></h2><p>You may pass the style settings of a <code>Cell</code> as a positional argument of type <a href="/SummaryTables.jl/previews/PR84/reference/infrastructure/cellstyle#CellStyle"><code>CellStyle</code></a>. It is usually more convenient, however, to use the keyword arguments to <code>Cell</code> instead.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> SummaryTables</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">])</span></span></code></pre></div><div><table id="st-53566267">
    ...
    <tr><td colspan="2" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div>`,41)]))}const g=i(e,[["render",l]]);export{E as __pageData,g as default};
