...
</table></div><h2 id="Optional-argument-2:-cellstyle" tabindex="-1">Optional argument 2: <code>cellstyle</code> <a class="header-anchor" href="#Optional-argument-2:-cellstyle" aria-label="Permalink to &quot;Optional argument 2: \`cellstyle\` {#Optional-argument-2:-cellstyle}&quot;">​</a></h2><p>You may pass the style settings of a <code>Cell</code> as a positional argument of type <a href="/SummaryTables.jl/v3/resources/api#SummaryTables.CellStyle"><code>CellStyle</code></a>. It is usually more convenient, however, to use the keyword arguments to <code>Cell</code> instead.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> SummaryTables</span></span>
<span class="line"></span>
<span class="line"></span>
